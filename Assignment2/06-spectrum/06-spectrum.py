...
numpyImage = cv2.imread(filename='/home/aishwarya/Desktop/Term2/IntroVisual/Assignment2/06-spectrum/lenna.png', flags=cv2.IMREAD_GRAYSCALE).astype(numpy.float32) / 255.0
...
numpyKernel =numpy.roll(numpy.roll(numpy.pad(numpyKernel,[(0, numpyImage.shape[0]-3), (0, numpyImage.shape[1]-3)], 'constant' ),1,1),1,0)
...
cv2.imwrite(filename='/home/aishwarya/Desktop/Term2/IntroVisual/Assignment2/06-spectrum/06-spectrum-1.png', img=cv2.applyColorMap(src=(numpySpectrum * 255.0).clip(0.0, 255.0).astype(numpy.uint8), colormap=cv2.COLORMAP_WINTER))
cv2.imwrite(filename='/home/aishwarya/Desktop/Term2/IntroVisual/Assignment2/06-spectrum/06-spectrum-2.png', img=(numpyImage * 255.0).clip(0.0, 255.0).astype(numpy.uint8))